...
public class CancelledOrders extends javax.swing.JFrame {
    ...
    public CancelledOrders(BurgerCollection burgerCollection) {
        initComponents();
    ...
    private void loadCancelledOrders(){
        ...
        DefaultTableModel dtm=(DefaultTableModel) cancelledOrderTable.getModel();
        dtm.setRowCount(0);
        for(int i=0; i<burgers.length; i++){
            if(burgers[i].getOrderStatus()==BurgerCollection.CANCEL){
    ...
    private void initComponents() {
        ...
        cancelledOrderTable = new javax.swing.JTable();
        ...
        cancelledOrderTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        cancelledOrderTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(cancelledOrderTable);
    ...
    private javax.swing.JTable cancelledOrderTable;
